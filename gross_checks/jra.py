...
if (not os.path.exists(sys.argv[1]) ):
  ...
  for line in fdic:
    ...
    for i in range (0,2920):
      try: 
        temporary_grid = model.variables[parm][i,:,:]
      except:
