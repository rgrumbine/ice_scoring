...
void contingency_derived(double a11, double a12, double a21, double a22, float &pod, float &far, float &fcr, float &pct, float &ts, float &bias);
...
void contingency(llgrid<float> &obs, llgrid<float> &model, grid2<float> &skip, float level, 
              double &a11, double &a12, double &a21, double &a22) {
  double area = 0;
  ijpt loc;
